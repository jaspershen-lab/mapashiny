...
MAPA needs OpenAI API key to annotate functional modules with LLM. If you do not have an OpenAI API key, please contact us, and we will (1) provide you with a temporary key for testing purpose, or (2) run the annotation step for you and send you the results.
